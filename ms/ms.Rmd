...
Our results, based on exhaustive national datasets, indicate that the French sanitary pass, and the later vaccine pass, did not solve Covid-19 vaccination heterogeneities, but instead crystallized them. <!-- Indicators that were the most strongly associated to vaccination rates are linked to poverty (the share of local income coming from unemployment benefits (`Unemployment_Benef`), and the proportion of overcrowded households (`Overcrowding_rate`)), immigration (the proportion of immigrants in the population (`Immigrant`)), -->
